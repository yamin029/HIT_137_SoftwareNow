"""
This tutorial is to detect number plate. 
Images are taken from Google for learning purpose only. 
...
# Reading the image
image = cv2.imread('./car_pictures/car2.jpeg')
cv2.imshow("Car number plate detection : ", image)
cv2.waitKey(0)


# Converting the image to grayscale from BGR
gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)

# # Displaying the grayscaled image in a plot.
plt.imshow(gray)
plt.show()
